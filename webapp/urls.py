...
from invoicing.views import display_creditnote, display_timesheet, generate_timesheet, display_invoice, generate_invoice, get_time_entries

urlpatterns = [
    url(r'^admin/', admin.site.urls),
    url(r'^admin/timesheet/', display_timesheet, name='timesheet'),
    url(r'^admin/generate_timesheet/', generate_timesheet),
    url(r'^admin/creditnote/', display_creditnote, name='display_creditnote'),
